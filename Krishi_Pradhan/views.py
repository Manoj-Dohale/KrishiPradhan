...
def login (request):
    connection = mysql.connector.connect(host="localhost",user="root",password="9405",database="accounts")
    cursor=connection.cursor()
    connection2 = mysql.connector.connect(host="localhost",user="root",password="9405",database="accounts")
...
def questionnare (request):
    if request.method=='POST':
        ...
        quest.save()
        connection3 = mysql.connector.connect(host="localhost",user="root",password="9405",database="accounts")
        cursor3=connection3.cursor()
        connection4 = mysql.connector.connect(host="localhost",user="root",password="9405",database="accounts")
        cursor4=connection4.cursor()
        connection5 = mysql.connector.connect(host="localhost",user="root",password="9405",database="accounts")
        cursor5=connection5.cursor()
        connection6 = mysql.connector.connect(host="localhost",user="root",password="9405",database="accounts")
